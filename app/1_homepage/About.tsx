...
export default function About() {
  return (
    <div className="flex flex-row items-center justify-center w-[85vw] bg-indigo-400 z-0 p-10">
      <div className="w-1/2 max-w-4xl px-24 py-10 flex flex-col justify-between min-h-[80vh] text-left">
      ...
      <div className="w-1/2 p-4 flex justify-center items-center overflow-hidden">        
        <Image 
