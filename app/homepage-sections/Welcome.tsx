...
export default function Welcome() {
  return (
    <div className="flex flex-row items-center justify-center w-[85vw] bg-white z-0 py-10">
      <div className="w-1/2 flex justify-center items-center overflow-hidden rounded-2xl">
        <Image 
  ...
  <div className="w-1/2 max-w-4xl p-4 flex flex-col justify-between min-h-[80vh] text-left">
